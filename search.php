...
<title>RollNRent | BikeListing</title>
<!--Bootstrap -->
...
<?php }} ?>
              ...
              <div class="form-group select">
                <select class="form-control">
                  ...
                  <option value="Petrol">Electrical Bike</option>
<option value="Diesel">Bike With Gear</option>
<option value="CNG">Bike Without Gear</option>
                </select>
              </div>
